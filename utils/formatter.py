...
def summarize_and_extract(subject, body):
    ...
    if tokens_used + estimated_tokens > MAX_TOKENS_TOTAL:
        print("⚠️ Token limit would be exceeded. Skipping OpenAI call.")
        return None, None  # <-- IMPORTANT: This prevents the API call
    prompt = f"""
...
"""
    ...
    tokens_used += estimated_tokens  # <- track usage here
